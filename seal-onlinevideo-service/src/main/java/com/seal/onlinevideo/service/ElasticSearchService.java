...
import com.seal.onlinevideo.dao.repository.UserInfoRepository;
import com.seal.onlinevideo.dao.repository.VideoRepository;
...
public class ElasticSearchService {
    ...
    public List<Map<String, Object>> getContents(String keyword,
        ...
        highlightBuilder.postTags("</span>");//终止标签
        ...
        for(SearchHit hit : searchResponse.getHits()){
            ...
            for(String key : array){
                ...
                if(field != null){
                    Text[] fragments = field.fragments();//多条内容
