...
import com.seal.onlinevideo.dao.VideoDao;
import com.seal.onlinevideo.domain.*;
import com.seal.onlinevideo.domain.exception.ConditionException;
import com.seal.onlinevideo.service.util.FastDFSUtil;
import com.seal.onlinevideo.service.util.ImageUtil;
import com.seal.onlinevideo.service.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.seal.onlinevideo.domain.File file = fileService.getFileByMd5(fileMd5);
